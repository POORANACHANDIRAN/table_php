        ...
        <form method="POST" action="employee_dbstore.php">
            <div class="detail10">
                <span class="flexing">
                    ...
                    <input type="text" placeholder="Enter Task Name" id="taskinput1" name="Firstname">
                </span>
                <span class="flexing">
                    <h2 id="tn">Last Name</h2>
                    <input type="text" placeholder="Enter Last Name" id="taskinput2" name="Lastname">
                </span>
                <span class="flexing">
                    <h2 id="tn">Password</h2>
                    <input type="password" placeholder="Enter Password" id="taskinput3" name="Password">
                </span>
                <span class="flexing">
                    <h2 id="tn">Status</h2>
                    <input type="text" placeholder="Enter Status" id="taskinput4" name="Status">
                </span>
            </div>
