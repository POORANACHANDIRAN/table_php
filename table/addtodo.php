...
<head>
    ...
    <link rel="stylesheet"  href="task.php">
...
<body>
    ...
    <section class="table">
        ...
        <form method="POST" action="dbstore.php">
            <div class="detail10">
                <span class="flexing">
                    <h2 id="tn">Task Name</h2>
                    <input type="text" placeholder="Enter Task Name" id="taskinput1" name="tname">
                </span>
                <span class="flexing">
                    <h2 id="tn">Task Description</h2>
                    <input type="text" placeholder="Enter Task Description" id="taskinput2" name="tdescription">
                </span>
                <span class="flexing">
                    <h2 id="tn">Assigned Date</h2>
                    <input type="text" placeholder="Enter Assigned Date" id="taskinput3" name="tadate">
                </span>
                <span class="flexing">
                    <h2 id="tn">Completed Date</h2>
                    <input type="text" placeholder="Enter Completed Date" id="taskinput4" name="tcompleteddate">
                </span>
            </div>
